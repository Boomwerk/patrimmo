    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="flex flex-col">
                ...
                {isSuccess && (
                    <p className="px-10 text-success text-sm mb-3">Votre mot de passe a été mis à jour.</p>
                )}
                {isError && (
                    <p className="px-10 text-error text-sm mb-3">Une erreur est survenue, veuillez réessayer.</p>
                )}
                ...
                <div className="flex justify-between items-center px-10">
                    ...
                    <fieldset className="fieldset w-250">
